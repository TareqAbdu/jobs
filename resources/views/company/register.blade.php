...
.candidate-login .checkbox-field {
    padding: 15px 0;
    display: flex;
    align-items: center;
...
.candidate-login .checkbox-field input[type="checkbox"] {
    margin-right: 10px;
    width:18px;
}

.candidate-login .checkbox-field label {
    font-weight: 700;
    color: #4C489D;
}

.candidate-login .checkbox-field .help-block {
    font-size: 12px;
    color: #D9534F;
    margin-top: 5px;
}
    ...
    <div class="container">
        <div class="screen">
            <div class="screen__content">
                ...
                <form class="login" class="form-horizontal"  method="POST" action="{{ route('company.register') }}">
                    {{ csrf_field() }}
                    <input type="hidden" name="candidate_or_employer" value="employer" />
                    <div class="login__field{{ $errors->has('name') ? ' has-error' : '' }}">
                        <i class="login__icon fas fa-user"></i>
                        <input  class="login__input" name="name" class="form-control" required="required" placeholder="{{__('Name')}}" value="{{old('name')}}">
                        @if ($errors->has('name'))
                    ...
                    <div class="checkbox-field{{ $errors->has('is_subscribed') ? ' has-error' : '' }}">
                        <?php
                        $is_checked = '';
                        ...
                        <label>{{__('Subscribe to Newsletter')}}</label>
                    ...
                    <div class="checkbox-field{{ $errors->has('terms_of_use') ? ' has-error' : '' }} mt-0">
                        <input type="checkbox" value="1" name="terms_of_use" />
                        <label><a href="{{url('cms/terms-of-use')}}">{{__('I accept Terms of Use')}}</a></label>
                ...
                {{--  <div class="social-login">
                    ...
                    <div class="social-icons">
                        <a href="{{ url('login/employer/facebook')}}"  class="social-login__icon fab fa-facebook"></a>
                        <a href="{{ url('login/employer/twitter')}}" class="social-login__icon fab fa-twitter"></a>
                    </div>
                </div>  --}}
            </div>

                ...
                <ul class="searchList">
                    ...
                    @else
                        ...
                        <div class="nodatabox">
                            ...
                            <div class="viewallbtn mt-2"><a class="btn btn-default btn-shadow ml-40 hover-up" href="{{url('/job-seekers')}}">{{__('Search Jobs')}}</a></div>
                        </div>
                    @endif
                </ul>
            </div>

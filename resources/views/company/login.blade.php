                        ...
                        <div class="col-lg-6">
                            <div class="auth-content card-body p-5 h-100 text-white">
                                <div class="w-100">
                                    ...
                                    <form action="{{ route('company.login') }}" method="POST" class="auth-form">
                                        {{ csrf_field() }}
                                    ...
                                    <div class="mt-4 text-center">
                                        <p class="mb-0">{{__('Dont have an account')}}? <a href="{{ route('employer_register') }}" class="fw-medium text-white text-decoration-underline">{{__('Register Here')}}</a></p>
                                    </div>
                                    <div class="mt-4 text-center">

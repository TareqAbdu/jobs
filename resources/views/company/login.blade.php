    ...
    <div class="container">
        <div class="screen">
            <div class="screen__content">
                <form class="login" class="form-horizontal" method="POST" action="{{ route('company.login') }}">
                    {{ csrf_field() }}
                    ...
                    <div class="mb-3 text-direct"><i class="fas fa-lock" aria-hidden="true"></i> {{__('Forgot Your Password')}}? <a href="{{ route('company.password.request') }}">{{__('Click here')}}</a></div>          
                    <div class="newuser text-direct"><i class="fa fa-user" aria-hidden="true"></i> {{__('New User')}}? <a href="{{route('employer_register')}}">{{__('Register Here')}}</a></div>

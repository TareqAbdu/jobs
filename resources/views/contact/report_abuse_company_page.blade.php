    ...
    <div class="row">
        <div class="col-12 mx-auto">
            <div class="contact-from-area padding-20-row-col">
                ...
                <form class="contact-form-style mt-25"method="post" action="{{ route('report.abuse.company', $slug)}}" name="contactform" id="contactform">
                    {{ csrf_field() }}
                    @include('flash::message')
    
                    <div class="row wow animate__animated animate__fadeInUp" data-wow-delay=".1s">
                        <div class="col-lg-6 col-md-6{{ $errors->has('listing_url') ? ' has-error' : '' }}">
                            {!! Form::text('company_url', route('company.detail', $slug), array('class'=>'form-control mb-3', 'id'=>'company_url', 'placeholder'=>__('URL'), 'required'=>'required', 'readonly'=>'readonly')) !!}                
                            @if ($errors->has('company_url')) <span class="help-block"> <strong>{{ $errors->first('company_url') }}</strong> </span> @endif
                        ...
                        <div class="col-lg-6 col-md-6 {{ $errors->has('your_name') ? ' has-error' : '' }}">
                            <div class="input-style mb-0">
                                <?php
                                        ...
                                        ?>
                                        {!! Form::text('your_name', $your_name, array('class'=>'form-control mb-3', 'id'=>'your_name', 'placeholder'=>__('Your Name'), 'required'=>'required')) !!}                
                        ...
                        <div class="col-lg-6 col-md-6{{ $errors->has('your_email') ? ' has-error' : '' }}">
                            <div class="input-style mb-20">
                                ...
                                ?>
                                {!! Form::text('your_email', $your_email, array('class'=>'form-control mb-3 mt-0', 'id'=>'your_email', 'placeholder'=>__('Your Email'), 'required'=>'required')) !!}                
                    ...
                    <button class="btn btn-default btn-small btn-find"  id="post_ad_btn" type="submit">{{__('Report')}}</button>

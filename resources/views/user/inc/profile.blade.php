...
<div class="row">
    ...
    <div class="col-md-6">
        <div class="formrow">
            ...
            <label class="btn btn-default btn-find"> {{__('Select Profile Image')}}
...
<div class="row">
 <div class="col-md-6">
    ...
    margin: -5px;" value="1" name="is_subscribed" {{$is_checked}} />
    ...
    <div class="col-md-12">
        <div class="formrow"><button type="submit" class="btn btn-default btn-find">{{__('Update Profile and Save')}}  <i class="fa fa-arrow-circle-right" aria-hidden="true"></i></button></div>
    </div>
</div>

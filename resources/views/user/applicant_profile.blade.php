...
@section('content')
    ...
    <section class="section-box bg-banner-about banner-home-3 pages user  pt-3 mb-0">
        ...
        @if ($user->bio_video !== '' && null !== $user->bio_video)
            <section class="section-md">
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                            <h4 class="header-title mb-3">{{ __('Video Profile') }} </h4>
                        </div>
                        <div class="col-sm-12 col-print-12">
                            <video id="my-video" class="video-js vjs-default-skin" controls preload="auto"
                                data-setup="{}" style="    width: 100%;    height: 400px;    margin-top: 15px;">
                        ...
                        <div class="contact-form">
                            ...
                            <form method="post" action="php/contact.php" name="contact-form" id="contact-form">
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-12">
                                        <input type="submit" value="Submit now" name="submit" id="submit"

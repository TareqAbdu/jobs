                                ...
                                <div class="card-job hover-up wow animate__animated animate__fadeInUp">
                                    <div class="card-job-top">
                                        ...
                                        <div class="card-job-top--info">
                                            <h6 class="card-job-top--info-heading"><a href="{{ route('job.detail', [$job->slug]) }}" title="{{ $job->title }}">{{ $job->title }}</a>
                                            </h6>
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <a href="{{ route('company.detail', $company->slug) }}" title="{{ $company->name }}"><span class="card-job-top--company">{{ $company->name }}</span>
                                                    </a> &nbsp;
                                    ...
                                    <div class="card-job-bottom mt-25">
                                        <div class="row">
                                            <div class="col-lg-12 col-sm-12 col-12">
                                                <a class="btn btn-small background-blue-light mr-5">{{ $job->getCareerLevel('career_level') }}</a>

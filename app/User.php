...
class User extends Authenticatable implements MustVerifyEmail
{
...

    {
        ...
        return CompanyMessage::where('seeker_id', '=', $this->id)->where('status', '=', 'unviewed')->where('type', '=', 'message')->orWhere('type', '=', 'meeting')->count();
...

    {
        ...
        return CompanyMessage::where('seeker_id', '=', $this->id)->where('company_id', '=', $id)->where('status', '=', 'unviewed')->where('type', '=', 'message')->orWhere('type', '=', 'meeting')->count();

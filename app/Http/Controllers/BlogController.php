...

{
...

    {
        ...
        $data['blogs'] = Blog::orderBy('id', 'DESC')->where('lang', 'like', \App::getLocale())->paginate(5);
        $data['latestBlogs'] = Blog::where('lang', 'like', \App::getLocale())->orderBy('created_at', 'desc')->limit(4)->get();

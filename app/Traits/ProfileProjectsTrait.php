...

{
...

    {
        ...
        if (isset($user) && count($user->profileProjects)):
            ...
            //   </li>';
            $html .= '<div class="col-md-4 col-6 p-0 nf-item">
            <div class="item-box">
                <a class="cbox-gallary1 mfp-image" href="' . $project->url . '" title="' . $project->name . '" target="_blank">
                    <img class="item-container" src="' . $image_url . '" alt="' . $project->name . '" />
                    <div class="item-mask">
                        <div class="item-caption">
                            <h5 class="text-white">' . $project->name . '</h5>
                            <p class="text-white">' . \Carbon\Carbon::parse($project->date_start)->format('d M, Y') . ' - ' . $date_end . '<br />
                            ' . \Illuminate\Support\Str::limit(strip_tags($project->description), 25, '...') . '</p>
                        </div>
                    </div>
                </a>

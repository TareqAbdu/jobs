        ...
        if (isset($user) && count($user->profileSkills)):
            ...
            foreach ($user->profileSkills as $skill):
                ...
                $html .= '<div class="col-6">
                            <div class="time-item mt-0">
                                <div class="item-info">
                                    <div class="font-14">'. $skill->getJobSkill('job_skill') . '</div>
                                    <p class="text text-success">'. $skill->getJobExperience('job_experience') .'</p>
                                </div>
                            </div>
                        </div>';
                ...
                if ($count % 2 == 0) {
                    $html .= '</div>';  // Close the row after two columns
                }
            endforeach;

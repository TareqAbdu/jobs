        ...
        if (isset($user) && count($user->profileEducation)):
            ...
            //   </li>';
              $html .= '<div class="time-item">
                                    <div class="item-info">
                                        <div class="font-14">'. $education->date_completion . ' - ' . $education->getCity('city') .'</div>
                                        <h5 class="my-1 text-dark">'. $education->getDegreeLevel('degree_level') . ' - ' . $education->getDegreeType('degree_type') .  '</h5>

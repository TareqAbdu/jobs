...
Route::get('candidate_login', 'Job8Controller@candidate_login')->name('candidate_login');

Route::get('employer_login', 'Job8Controller@company_login')->name('company_login');
Route::get('employer_register', 'Job8Controller@employer_register')->name('employer_register');
Route::get('candidate_register', 'Job8Controller@candidate_register')->name('candidate_register');
